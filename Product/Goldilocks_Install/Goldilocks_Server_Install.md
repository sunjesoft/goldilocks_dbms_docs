# Goldilocks Linux Server 설치 가이드
...
###### 커널이 3.2 이상인 경우 RemoveIPC 값을 no 로 변경한다.
...
#### 6 - 2. OS 인코딩에 따라 데이터베이스 생성시 옵션을 부여한다.
...
#### 6 - 3. 데이터베이스 생성시 옵션을 부여하여 설정을 변경할 수 있다.<br/> gcreatedb --help 로 옵션사용법을 확인할 수 있다..
...
###### $GOLDILOCKS_DATA/conf/goldilocks.properties.conf 파일에서 6 - 3 의 옵션에 포함되지 않은 다른 프로퍼티를 설정할 수 있다.
